...
const GATED_PAGE_FEATURES: { path: string; feature: FeatureKey }[] = [
  ...
  { path: "/dashboard/matches", feature: "match_centre" },
  { path: "/dashboard/training", feature: "training_planner" },
  { path: "/dashboard/video", feature: "video_analysis" },
  { path: "/dashboard/news", feature: "academy_news" },
  { path: "/dashboard/enquiries", feature: "academy_enquiries" },
  { path: "/dashboard/payments", feature: "parent_payments" },
  { path: "/dashboard/finance", feature: "finance_centre" },
